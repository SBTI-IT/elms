...
$sql="update roles set name=:name,description=:description where id=:lid";
...
<input id="name" type="text"  class="validate" autocomplete="off" name="name" value="<?php echo htmlentities($result->name);?>"  required>
          ...
          <div class="input-field col s12">
<textarea id="description" name="description" class="materialize-textarea" name="description" length="500"><?php echo htmlentities($result->description);?></textarea>
