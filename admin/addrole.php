...
<input id="roleName" type="text"  class="validate" autocomplete="off" name="name"  required>
                                                <label for="roleName">Role name</label>
                                            </div>


          <div class="input-field col s12">
<textarea id="description" name="description" class="materialize-textarea" name="description" length="500"></textarea>
