...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Supervisor | Leave History</title>
...
<?php 
$eid=$_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status from leaves where empid=:eid";
